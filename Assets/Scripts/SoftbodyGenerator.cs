...
public class SoftbodyGenerator : MonoBehaviour
{
    ...
    private void Update()
    {
        if (debugMode)
        {
            ...
            {
                Debug.DrawLine(
                    physicedVertexes[jointIndex.x].transform.position,
                    physicedVertexes[jointIndex.y].transform.position,
                    physicedVertexes[jointIndex.x].GetComponent<DebugColorGameObject>().Color);
            }
        ...
        {
            tempVertexes[i] = physicedVertexes[vertexDictionary[i]].transform.localPosition;
        }
...
public class LookAtPointEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        softbody.collisionSurfaceOffset = EditorGUILayout.FloatField("Softbody Offset", softbody.collisionSurfaceOffset);
    }
}
